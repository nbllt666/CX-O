...
Miniconda3\python.exe -m pip install -r requirements_gradio.txt -i https://pypi.tuna.tsinghua.edu.cn/simple
Miniconda3\python.exe -m pip install -r requirements_gradio.txt -i https://pypi.python.org/simple/
