...
import type { IAvatarDriver } from './avatar-driver';
import type { ExpressionLayer } from './avatar-manifest';

// Liquid Glass: data-glass 属性构建（容器层注入）
...
export function AvatarTypeSelector() {
  ...
  return (
    <div
      className="flex items-center gap-1 p-1 bg-[var(--color-bg-tertiary)] rounded-lg"
      data-glass={glassAttributes['data-glass'] ?? undefined}
      data-glass-tier={glassAttributes['data-glass-tier'] ?? undefined}
    >
