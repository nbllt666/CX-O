...
// Liquid Glass: data-glass 属性构建（管理器容器注入）
...
export function AvatarManager({ type, onClose }: AvatarManagerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--color-bg-primary)]/60">
      <div
        className="flex w-[calc(100vw-4rem)] h-[calc(100vh-4rem)] bg-[var(--color-bg-primary)] rounded-2xl shadow-2xl overflow-hidden"
