 ...
 *
 * v2 改造要点:
 *   - ✂️ 删除 useGlassTier / isValidGlassTier / injectGlassClassName 调用
 *   - ✨ 直接使用 glassPanelClass 常量拼接
 *   - ✨ buildGlassDataAttributes 简化为单参数
 *
 * 契约对齐:
 ...
 *   - 挂载 data-glass 属性，由 WebGL 层（LiquidGlassHost）接管玻璃渲染
...
export const Badge = React.forwardRef<HTMLSpanElement, BadgeProps>(
  function Badge(
    ...
    const composedClassName = cn(badgeBaseClassName, glassPanelClass);
